...
class tpqibcon(ib.opt.Connection):
    def __init__(self, host='127.0.0.1', port=7497, clientId=0,receiver=None, sender=None, dispatcher=None):
        ...
        super(tpqibcon, self).__init__(host, port, clientId, receiver, sender, dispatcher)
